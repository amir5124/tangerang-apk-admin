...
export default function ReportsScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-[#F5F7FA]" contentContainerStyle={{ padding: 20 }}>
      <Text className="text-2xl font-bold text-gray-800 pt-8">Analisis Laporan</Text>

      <View className="flex-row bg-white p-1 rounded-2xl mb-6 border border-gray-100 mt-4">
