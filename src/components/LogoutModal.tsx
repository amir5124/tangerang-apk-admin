    ...
    <Modal visible={visible} transparent animationType="fade">
      <Pressable style={styles.overlay} onPress={onClose}>
        <Animated.View style={[styles.modalContainer, { transform: [{ scale: scaleValue }] }]}>
          ...
          <Text style={styles.message}>Apakah Anda yakin ingin keluar? Sesi Anda akan berakhir.</Text>

          <View style={styles.buttonGroup}>
            <TouchableOpacity activeOpacity={0.7} style={[styles.button, styles.cancelButton]} onPress={onClose}>
              <Text style={styles.cancelText}>Batal</Text>
            </TouchableOpacity>

            <TouchableOpacity activeOpacity={0.8} style={[styles.button, styles.confirmButton]} onPress={onConfirm}>
  ...
  modalContainer: {
    ...
    ...Platform.select({
      ...
      web: {
        ...
        outlineStyle: "none", // Menghilangkan border fokus biru di browser
      },
      // Untuk ANDROID
      android: {
        elevation: 20,
